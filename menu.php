...
<?php	
	...
	foreach ( $sortedIPROs as $key => $val ) {
		...
		if ( in_array( $semester->getID(), $_SESSION['expandSemesters'] ) ) {
			print "<li><a href=\"?toggleExpand=".$semester->getID()."\"><img src=\"img/minus.png\" border=\"0\" alt=\"-\" /></a>&nbsp;<a href=\"?toggleExpand=".$semester->getID()."\">".$semester->getName()."</a>";
			print "<ul>\n";
			ksort( $val );
			...
			print "<li><a href=\"?toggleExpand=".$semester->getID()."\"><img src=\"img/plus.png\" border=\"0\" alt=\"+\" /></a>&nbsp;<a href=\"?toggleExpand=".$semester->getID()."\">".$semester->getName()."</a>";
		print "</li>";
	}
	print "</ul>\n";
	
	if ( in_array( "igroups", $_SESSION['expandSemesters'] ) ) {
		print "<a href=\"?toggleExpand=igroups\"><img src=\"img/minus.png\" border=\"0\" alt=\"-\" /></a>&nbsp;<a href=\"?toggleExpand=igroups\">Your Other Groups:</a>\n";
		@ksort( $igroups );
		print "<ul>\n";
		if ( isset($igroups)) {
		...
		print "<a href=\"?toggleExpand=igroups\"><img src=\"img/plus.png\" border=\"0\" alt=\"+\" /></a>&nbsp;<a href=\"?toggleExpand=igroups\">Your Other Groups:</a><br /><br />\n";

	if ( $currentUser->isAdministrator() ) {
		if ( in_array( "admin", $_SESSION['expandSemesters'] ) ) {
			print "<a href=\"?toggleExpand=admin\"><img src=\"img/minus.png\" border=\"0\" alt=\"-\" /></a>&nbsp;<a href=\"?toggleExpand=admin\">Administrative Tools:</a>";
			print "<ul>";
			...
			print "<a href=\"?toggleExpand=admin\"><img src=\"img/plus.png\" border=\"0\" alt=\"+\" /></a>&nbsp;<a href=\"?toggleExpand=admin\">Administrative tools:</a>";
	}
?>
	<ul class="noindent">

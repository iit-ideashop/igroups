<?php
	...
	if (isset($_SESSION['adminView'])) {
		$query = $db->iknowQuery("SELECT * FROM Projects p, ProjectSemesterMap m WHERE m.iSemesterID={$currentSemesterID} AND m.iProjectID=p.iID ORDER BY p.sIITID");
		$groups = array();
...
<form method="get" action="dboard.php">

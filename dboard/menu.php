...
<?php	
	...
	foreach ( $sortedIPROs as $key => $val ) {
		...
		if ( in_array( $semester->getID(), $_SESSION['expandSemesters'] ) ) {
			print "<li><a href=\"dboard.php?toggleExpand=".$semester->getID()."\"><img src=\"../img/minus.gif\" border=\"0\" alt=\"-\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=".$semester->getID()."\">".$semester->getName()."</a>";
			print "<ul>\n";
			ksort( $val );
			...
			print "<li><a href=\"dboard.php?toggleExpand=".$semester->getID()."\"><img src=\"../img/plus.gif\" border=\"0\" alt=\"+\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=".$semester->getID()."\">".$semester->getName()."</a>";
		print "</li>";
	}
	print "</ul>\n";
	
	if ( in_array( "igroups", $_SESSION['expandSemesters'] ) ) {
		print "<a href=\"dboard.php?toggleExpand=igroups\"><img src=\"../img/minus.gif\" border=\"0\" alt=\"-\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=igroups\">Your Other Groups:</a>\n";
		@ksort( $igroups );
		print "<ul>\n";
		if ( isset($igroups)) {
		...
		print "<a href=\"dboard.php?toggleExpand=igroups\"><img src=\"../img/plus.gif\" border=\"0\" alt=\"+\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=igroups\">Your Other Groups:</a><br /><br />\n";

	if ( $currentUser->isAdministrator() ) {
		if ( in_array( "admin", $_SESSION['expandSemesters'] ) ) {
			print "<a href=\"dboard.php?toggleExpand=admin\"><img src=\"../img/minus.gif\" border=\"0\" alt=\"-\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=admin\">Administrative Tools:</a>";
			print "<ul>";
			...
			print "<a href=\"dboard.php?toggleExpand=admin\"><img src=\"../img/plus.gif\" border=\"0\" alt=\"+\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=admin\">Administrative tools:</a>";
	}
?>
	<ul class="noindent">

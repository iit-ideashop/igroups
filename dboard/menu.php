...
<?php	
	...
	if(count($sortedIPROs) > 0)
	{
		...
		foreach ( $sortedIPROs as $key => $val ) {
			...
			if ( in_array( $semester->getID(), $_SESSION['expandSemesters'] ) ) {
				echo "<li><a href=\"dboard.php?toggleExpand=".$semester->getID()."\"><img src=\"../img/minus.png\" style=\"border-style: none\" alt=\"-\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=".$semester->getID()."\">".$semester->getName()."</a>";
				echo "<ul>\n";
				ksort( $val );
				...
				echo "<li><a href=\"dboard.php?toggleExpand=".$semester->getID()."\"><img src=\"../img/plus.png\" style=\"border-style: none\" alt=\"+\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=".$semester->getID()."\">".$semester->getName()."</a>";
			echo "</li>";
		}
		echo "</ul>\n";
	}
	...
	if ( in_array( "igroups", $_SESSION['expandSemesters'] ) ) {
		echo "<a href=\"dboard.php?toggleExpand=igroups\"><img src=\"../img/minus.png\" style=\"border-style: none\" alt=\"-\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=igroups\">Your Other Groups:</a>\n";
		@ksort( $igroups );
		echo "<ul>\n";
		if ( isset($igroups)) {
		...
		echo "<a href=\"dboard.php?toggleExpand=igroups\"><img src=\"../img/plus.png\" style=\"border-style: none\" alt=\"+\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=igroups\">Your Other Groups:</a><br /><br />\n";

	if ( $currentUser->isAdministrator() ) {
		if ( in_array( "admin", $_SESSION['expandSemesters'] ) ) {
			echo "<a href=\"dboard.php?toggleExpand=admin\"><img src=\"../img/minus.png\" style=\"border-style: none\" alt=\"-\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=admin\">Administrative Tools:</a>";
			echo "<ul>";
			...
			echo "<a href=\"dboard.php?toggleExpand=admin\"><img src=\"../img/plus.png\" style=\"border-style: none\" alt=\"+\" /></a>&nbsp;<a href=\"dboard.php?toggleExpand=admin\">Administrative tools:</a>";
	}
?>
	<ul class="noindent">

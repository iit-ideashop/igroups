...
<?php
	...
	$query = $db->igroupsQuery("SELECT GroupEmails.iID, People.sFName, People.sLName FROM GroupEmails inner join People on GroupEmails.iSenderID=People.iID FROM GroupEmails WHERE GroupEmails.iSemesterID={$currentSemester->getID()}".$add);

...
<?php
	...
	echo "<h1>$name</h1>\n";
	echo "<div><form method=\"post\" action=\"taskedit.php?taskid={$task->getID()}\"><fieldset><legend id=\"taskedit\">Edit this Task</legend>\n";
	...
	echo "<input value=\"Edit Task\" type=\"submit\" /><input type=\"reset\" /><input name=\"form\" value=\"edittask\" type=\"hidden\" /></fieldset></form></div>\n";

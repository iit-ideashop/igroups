...
foreach($pages as $page)
        print "$page&nbsp;";
?>
</td><td align='center'><?php print "<a href='dboard.php'>iGroups Discussion Board</a> -&gt; <a href='{$_SESSION['topicLink']}'>{$_SESSION['topicName']}</a>"; ?></td><td class='post_options' align='right'><a href='create.php?mode=thread'><img src="../img/newthread.png" border="0" alt="New Thread" title="New Thread" /></a>&nbsp;<a href='create.php?mode=post'><img src="../img/newpost.png" border="0" alt="Post Reply" title="Post Reply" /></a></td></tr></table>

<table width='85%' cellspacing='0' cellpadding='5' border='1' align='center' style='table-layout: fixed'>

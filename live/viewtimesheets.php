...
?>
        <form method="post" action="viewtimesheets.php">
                Date (MM/DD/YYYY): <input type="text" id="date" name="date" onclick="ds_sh(this);" style="cursor: text" value='<?php print "{$editTime->getDate()}"; ?>' /><br />
                Hours Spent: <input type="text" name="hours" value='<?php print "{$editTime->getHoursSpent()}"; ?>' />
<br />
                Tasks Worked On:<br />
                <textarea name="description" cols=50 rows=5><?php print "{$editTime->getTaskDescription()}"; ?></textarea><br />
<?php
...
?>
        <form method="post" action="viewtimesheets.php">
                ...
                Estimated Hours: <input type="text" name="taskHours" value='<?php print "{$editTask->getHoursSpent()}"; ?>' /><br />
                Tasks:<br />
                <textarea name="taskDescription" cols=50 rows=5><?php print "{$editTask->getTaskDescription()}"; ?></textarea><br />
<?php

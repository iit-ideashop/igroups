		...
		<div id="recent">
				<div class="box">
					...
					if(count($emails) > 0) {
						...
						foreach ( $emails as $email ) {
							print "<li><a href=\"email.php?display=".$email->getID()."\">".$email->getSubject()."(".$email->getDateTime().")</a></li>";
						}
					print "</ul>";
					}
				...
				if(count($files) > 0) {
					...
					foreach ( $files as $file ) {
						print "<li><a href=\"download.php?id=".$file->getID()."\">".$file->getName()."(".$file-getDateTime().")</a></li>";
					}
					print "</ul>";
				}

...
<?php
	...
	//Add a task
	echo "<div><form method=\"post\" action=\"tasks.php\"><fieldset><legend>Add Task</legend>\n";
	...
	echo "<input type=\"submit\" value=\"Add\" /><input type=\"hidden\" name=\"form\" value=\"addtask\" /></fieldset></form></div>\n";
?>
</div></body>
</html>

...
?>
		<label for="date">Date (MM/DD/YYYY):</label><input type="text" class="datepickalt" name="date" style="cursor: text" value='<?php if (isset($editTime)) print "{$editTime->getDate()}"; ?>' /><br />
...
?>
		<label for="taskDate">Date (MM/DD/YYYY):</label><input type="text" class="datepickalt" name="taskDate" style="cursor: text" value="<?php if (isset($editTask)) print "{$editTask->getDate()}"; ?>" /><br />
